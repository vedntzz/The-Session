...
const GOLDEN: readonly string[] = [
  ...
  "",
  "  id        started      intent                        class  outcome    drift files  turns     tokens  empty   cost",
  "  11111111  01-15 14:02  add rate limiting to /orders  api    merged               1      7  1,105,600      2  $3.69",
  "  11111111  01-16 08:31  extract the store             other  abandoned            0      3      1,100      0  $0.02",
  "  11111111  01-17 10:00  try the new model             other  open                 0      1        500      1      —",
  "",
  ...
  "  11111111  01-15 14:02  add rate limiting to /orders  merged             1      7      2  $3.69",
  "",
  "  1 session                                                               1      7      2",
